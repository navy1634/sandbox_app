...
const (
	// Label holds the string label denoting the appaccount type in the database.
	Label = "app_account"
	...
	// Table holds the table name of the appaccount in the database.
	Table = "app_accounts"
)

// Columns holds all SQL columns for appaccount fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the AppAccount queries.
